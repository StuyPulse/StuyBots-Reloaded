...
public class Pump extends SubsystemBase {
    ...
    public Pump() {
        ...
        pressureGauge = new AnalogInput(Constants.Ports.Pneumatics.ANALOG_PRESSURE_SWITCH_PORT);
    ...
    public void periodic() {
        if (getPressure() / 1000.0 < 120.0) compress();
        else stop();
        
        if (enabled.get()) compressor.enableDigital();
